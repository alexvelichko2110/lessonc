...
all: hello printf fprintf param
...
fprintf: fprintf.o
	$(CC) $(LDFLAGS) fprintf.o -o fprintf $(LIBS) $(AL_LIBS) -lc

param: param.o
	$(CC) $(LDFLAGS) param.o -o param $(LIBS) $(AL_LIBS) -lc
...
clean:
	rm -r -f hello hello.o printf printf.o fprintf fprintf.o param param.o 2> /dev/null
